...
<html lang="en">
  ...
  <body>
    <?php headerNoLogin("Privacy Policy") ?>
    <div class="privacyPolicy">
      <h2>Our Pledge</h2>
        <p>RMIT Web Programming Studio Group 1 is committed to providing quality services to you and this policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.</p>
      ...
      <h2>What is Personal Information and why do we collect it?</h2>
        ...
        <p>This Personal Information is obtained in many ways including during the signup and any personal information you supply through the forums and the event planner. We don't guarantee website links or policy of authorised third parties.</p>
        <p>We collect your Personal Information for the primary purpose of providing our services to you. </p>
      ...
      <h2>Sensitive Information</h2>
        ...
        <h3>Sensitive information will be used by us only:</h3>
        <ul>
      ...
      <h2>Disclosure of Personal Information</h2>
        <h3>Your Personal Information may be disclosed in a number of circumstances including the following:</h3>
        <ul>
          <li>Where required or authorised by law.</li>
        </ul>

      <h2>Security of Personal Information</h2>
        <p>Your Personal Information is stored in a manner that reasonably protects it from misuse and loss and from unauthorized access, modification or disclosure. This includes encrypting your passwords so even in the event of a data breach, your passwords will be secure.</p>
        <p>When your Personal Information is no longer needed for the purpose for which it was obtained, we will take reasonable steps to destroy or permanently de-identify your Personal Information. However, most of the Personal Information is or will be stored in client files which will be kept by us for a minimum of 7 years.</p>
      
        <h2>Access to your Personal Information</h2>
        <p>You may access the Personal Information we hold about you and to update and/or correct it, subject to certain exceptions. If you wish to access your Personal Information, please contact us in writing or online using the contact details at the bottom of the page.</p>
        <p>RMIT Web Programming Studio Group 1 will not charge any fee for your access request, but may charge an administrative fee for providing a copy of your Personal Information.</p>
      ...
      <h2>Privacy Policy Complaints and Enquiries</h2>
        <p>If you have any queries or complaints about our Privacy Policy please contact us at the links at the bottom of the page.</p>
    </div>
    <?php
      makeFooter();
    ?>
